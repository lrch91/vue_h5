/* Zepto 1.2.0 - zepto event ajax form ie fx fx_methods touch - zeptojs.com/license */ ! function (t, e) {
    ...
    var e = function () {
        ...
        return C.matches = function (t, e) {
            ...
            css: function (t, e) {
                ...
                var a = "";
                if ("string" == D(t)) e || 0 === e ? a = I(t) + ":" + X(t, e) : this.each(function () {
                    this.style.removeProperty(I(t))
                });
                else
                    for (n in t) t[n] || 0 === t[n] ? a += I(n) + ":" + X(n, t[n]) + ";" : this.each(function () {
                            ...
                            if (N.status >= 200 && N.status < 300 || 304 == N.status || 0 == N.status && "file:" == C) {
                                if (c = c || T(s.mimeType || N.getResponseHeader("content-type")), "arraybuffer" == N.responseType || "blob" == N.responseType) t = N.response;
                                    ...
                                    try {
                                        ...
                                        //=======
                                        t = decodeURIComponent(N.responseText);
                                        N.responseText = t;
                                        try {
                                            t = w(t, c, s), "script" == c ? (1, eval)(t) : "xml" == c ? t = N.responseXML : "json" == c && (t = l.test(t) ? null : e.parseJSON(t))
                                        } catch (i) {
